...
package notebook.controller.apis;
...
public class CustomResourceApi {
    ...
    public CustomResourceApi() {
        this(Configuration.getDefaultApiClient());
    }

    public CustomResourceApi(ApiClient apiClient) {
     ...
     */
    public okhttp3.Call createNamespacedCustomObjectCall(String group, String version, String namespace, String kind, Object body, String pretty, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = body;
        String localVarPath = null;
        String plural = OperatorFunc.pluralMapper.get(kind);

     // create path and map variables
        if(group.equals("core")) {
        	localVarPath = "/api/v1/namespaces/{namespace}/{plural}"
                    .replaceAll("\\{" + "namespace" + "\\}", localVarApiClient.escapeString(namespace.toString()))
                    .replaceAll("\\{" + "plural" + "\\}", localVarApiClient.escapeString(plural.toString()));
        } else {
        	localVarPath = "/apis/{group}/{version}/namespaces/{namespace}/{plural}"
                    .replaceAll("\\{" + "group" + "\\}", localVarApiClient.escapeString(group.toString()))
                    .replaceAll("\\{" + "version" + "\\}", localVarApiClient.escapeString(version.toString()))
                    .replaceAll("\\{" + "namespace" + "\\}", localVarApiClient.escapeString(namespace.toString()))
                    .replaceAll("\\{" + "plural" + "\\}", localVarApiClient.escapeString(plural.toString()));
     ...
     */
    public okhttp3.Call deleteNamespacedCustomObjectCall(String group, String version, String namespace, String kind, String name, V1DeleteOptions body, Integer gracePeriodSeconds, Boolean orphanDependents, String propagationPolicy, final ApiCallback _callback) throws ApiException {
    	Object localVarPostBody = body;
        String localVarPath = null;
        String plural = OperatorFunc.pluralMapper.get(kind);
        ...
        // create path and map variables
        if(group.equals("core")) {
        	localVarPath = "/api/v1/namespaces/{namespace}/{plural}/{name}"
                    .replaceAll("\\{" + "namespace" + "\\}", localVarApiClient.escapeString(namespace.toString()))
                    .replaceAll("\\{" + "plural" + "\\}", localVarApiClient.escapeString(plural.toString()))
        			.replaceAll("\\{" + "name" + "\\}", localVarApiClient.escapeString(name.toString()));
        } else {
        	localVarPath = "/apis/{group}/{version}/namespaces/{namespace}/{plural}/{name}"
                    .replaceAll("\\{" + "group" + "\\}", localVarApiClient.escapeString(group.toString()))
                    .replaceAll("\\{" + "version" + "\\}", localVarApiClient.escapeString(version.toString()))
                    .replaceAll("\\{" + "namespace" + "\\}", localVarApiClient.escapeString(namespace.toString()))
                    .replaceAll("\\{" + "plural" + "\\}", localVarApiClient.escapeString(plural.toString()))
